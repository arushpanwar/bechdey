...
const Header = () => {
  ...
  return (
    <header className="text-gray-600 body-font flex flex-col justify-center">
      <div className="container flex flex-wrap py-4 px-8 flex-col items-center ">
        <div className="w-full flex justify-between items-center px-60">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7    h-7">
          ...
          <Link legacyBehavior href={"/"}>
            <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 py-2">
              ...
              <span className="ml-3 font-semibold text-blue-950 text-3xl">Rentway</span>
            </a>
          </Link>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 mx-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 mx-2 cursor-pointer " onClick={signInWithGoogle}>
